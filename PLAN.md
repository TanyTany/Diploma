...
### <a name="Positive"></a> Позитивные сценарии
...
### <a name="Month"></a> Работа с полем “Месяц” для Payment Gate и Credit Gate
*Сначала проверяется поле по кнопке “Купить”, далее по кнопке “Купить в кредит”*
...
### <a name="Year"></a> Работа с полем “Год” для Payment Gate и Credit Gate
*Сначала проверяется поле по кнопке “Купить”, далее по кнопке “Купить в кредит”*
...
### <a name="Owner"></a> Работа с полем “Владелец” для Payment Gate и Credit Gate
*Сначала проверяется поле по кнопке “Купить”, далее по кнопке “Купить в кредит”*
...
### <a name="CVC"></a> Работа с полем “CVC/CVV” для Payment Gate и Credit Gate
*Сначала проверяется поле по кнопке “Купить”, далее по кнопке “Купить в кредит”*
...
- Недостаточно опыта работы с некоторыми инструментами
